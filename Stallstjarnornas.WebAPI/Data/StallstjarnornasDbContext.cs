    ...
    public class StallstjarnornasDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasData(
                ...
                // Sittning 1, måndag 11 maj FULLBOKAD (2+4+6+8+6+8+8+8 = 50)
                ...
                new Booking { Id = 13, GuestId = 13, SittingId = 1, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1013, CreatedDate = new DateTime(2026, 5, 7), Message = "Äggallergi" },
                new Booking { Id = 14, GuestId = 14, SittingId = 1, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 2, Status = "Pending", BookingNumber = 1014, CreatedDate = new DateTime(2026, 5, 7), Message = null },
                new Booking { Id = 15, GuestId = 15, SittingId = 1, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1015, CreatedDate = new DateTime(2026, 5, 7), Message = null },
                new Booking { Id = 16, GuestId = 16, SittingId = 2, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1016, CreatedDate = new DateTime(2026, 5, 8), Message = "Nötallergi" },
                new Booking { Id = 17, GuestId = 17, SittingId = 2, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1017, CreatedDate = new DateTime(2026, 5, 8), Message = null },
                new Booking { Id = 18, GuestId = 18, SittingId = 2, BookingDate = new DateTime(2026, 5, 12), NoOfGuests = 2, Status = "Cancelled", BookingNumber = 1018, CreatedDate = new DateTime(2026, 5, 8), Message = "Sojaöverkänslighet" },

                new Booking { Id = 19, GuestId = 19, SittingId = 1, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1019, CreatedDate = new DateTime(2026, 5, 9), Message = null },
                new Booking { Id = 20, GuestId = 20, SittingId = 1, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1020, CreatedDate = new DateTime(2026, 5, 9), Message = null },
                new Booking { Id = 21, GuestId = 21, SittingId = 1, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1021, CreatedDate = new DateTime(2026, 5, 9), Message = "Celiaki, strikt glutenfri mat krävs" },
                new Booking { Id = 22, GuestId = 22, SittingId = 2, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 3, Status = "Pending", BookingNumber = 1022, CreatedDate = new DateTime(2026, 5, 9), Message = null },
                new Booking { Id = 23, GuestId = 23, SittingId = 2, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1023, CreatedDate = new DateTime(2026, 5, 10), Message = "Laktosintolerant" },
                new Booking { Id = 24, GuestId = 24, SittingId = 2, BookingDate = new DateTime(2026, 5, 13), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1024, CreatedDate = new DateTime(2026, 5, 10), Message = null },

                new Booking { Id = 25, GuestId = 25, SittingId = 1, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1025, CreatedDate = new DateTime(2026, 5, 10), Message = null },
                new Booking { Id = 26, GuestId = 26, SittingId = 1, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 6, Status = "Cancelled", BookingNumber = 1026, CreatedDate = new DateTime(2026, 5, 10), Message = "Skaldjursallergi" },
                new Booking { Id = 27, GuestId = 27, SittingId = 1, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1027, CreatedDate = new DateTime(2026, 5, 10), Message = null },
                new Booking { Id = 28, GuestId = 28, SittingId = 2, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1028, CreatedDate = new DateTime(2026, 5, 10), Message = null },
                new Booking { Id = 29, GuestId = 29, SittingId = 2, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 4, Status = "Pending", BookingNumber = 1029, CreatedDate = new DateTime(2026, 5, 10), Message = "Ägg- och nötallergi" },
                new Booking { Id = 30, GuestId = 30, SittingId = 2, BookingDate = new DateTime(2026, 5, 14), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1030, CreatedDate = new DateTime(2026, 5, 10), Message = null },
                ...
                new Booking { Id = 35, GuestId = 5, SittingId = 1, BookingDate = new DateTime(2026, 5, 19), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1035, CreatedDate = new DateTime(2026, 5, 12), Message = null },
                new Booking { Id = 36, GuestId = 6, SittingId = 1, BookingDate = new DateTime(2026, 5, 19), NoOfGuests = 5, Status = "Cancelled", BookingNumber = 1036, CreatedDate = new DateTime(2026, 5, 13), Message = null },
                new Booking { Id = 37, GuestId = 7, SittingId = 2, BookingDate = new DateTime(2026, 5, 19), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1037, CreatedDate = new DateTime(2026, 5, 13), Message = null },
                new Booking { Id = 38, GuestId = 8, SittingId = 2, BookingDate = new DateTime(2026, 5, 19), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1038, CreatedDate = new DateTime(2026, 5, 13), Message = "Skaldjursallergi" },
                new Booking { Id = 39, GuestId = 9, SittingId = 1, BookingDate = new DateTime(2026, 5, 22), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1039, CreatedDate = new DateTime(2026, 5, 14), Message = null },
                new Booking { Id = 40, GuestId = 10, SittingId = 1, BookingDate = new DateTime(2026, 5, 22), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1040, CreatedDate = new DateTime(2026, 5, 14), Message = null },
                new Booking { Id = 41, GuestId = 11, SittingId = 2, BookingDate = new DateTime(2026, 5, 22), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1041, CreatedDate = new DateTime(2026, 5, 14), Message = "Vegansk" },
                new Booking { Id = 42, GuestId = 12, SittingId = 2, BookingDate = new DateTime(2026, 5, 22), NoOfGuests = 2, Status = "Pending", BookingNumber = 1042, CreatedDate = new DateTime(2026, 5, 15), Message = null },
                new Booking { Id = 43, GuestId = 13, SittingId = 1, BookingDate = new DateTime(2026, 5, 23), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1043, CreatedDate = new DateTime(2026, 5, 15), Message = null },
                new Booking { Id = 44, GuestId = 14, SittingId = 1, BookingDate = new DateTime(2026, 5, 23), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1044, CreatedDate = new DateTime(2026, 5, 15), Message = "Äggallergi" },
                new Booking { Id = 45, GuestId = 15, SittingId = 2, BookingDate = new DateTime(2026, 5, 23), NoOfGuests = 7, Status = "Confirmed", BookingNumber = 1045, CreatedDate = new DateTime(2026, 5, 15), Message = null },

                // Vecka 22 2026 (25-31 maj) - Fullbokad lördag kväll sittning 1
                new Booking { Id = 46, GuestId = 16, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1046, CreatedDate = new DateTime(2026, 5, 16), Message = null },
                new Booking { Id = 47, GuestId = 17, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1047, CreatedDate = new DateTime(2026, 5, 16), Message = null },
                new Booking { Id = 48, GuestId = 18, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1048, CreatedDate = new DateTime(2026, 5, 17), Message = "Sojaöverkänslighet" },
                new Booking { Id = 49, GuestId = 19, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1049, CreatedDate = new DateTime(2026, 5, 17), Message = null },
                new Booking { Id = 50, GuestId = 20, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1050, CreatedDate = new DateTime(2026, 5, 17), Message = null },
                new Booking { Id = 51, GuestId = 21, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1051, CreatedDate = new DateTime(2026, 5, 17), Message = "Celiaki" },
                new Booking { Id = 52, GuestId = 22, SittingId = 1, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1052, CreatedDate = new DateTime(2026, 5, 18), Message = null },
                // Sittning 1, lördag 30 maj FULLBOKAD (8+8+8+8+8+6+4 = 50)

                new Booking { Id = 53, GuestId = 23, SittingId = 2, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1053, CreatedDate = new DateTime(2026, 5, 18), Message = null },
                new Booking { Id = 54, GuestId = 24, SittingId = 2, BookingDate = new DateTime(2026, 5, 30), NoOfGuests = 5, Status = "Pending", BookingNumber = 1054, CreatedDate = new DateTime(2026, 5, 18), Message = "Laktosintolerant" },
                new Booking { Id = 55, GuestId = 25, SittingId = 1, BookingDate = new DateTime(2026, 5, 29), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1055, CreatedDate = new DateTime(2026, 5, 18), Message = null },
                new Booking { Id = 56, GuestId = 26, SittingId = 1, BookingDate = new DateTime(2026, 5, 29), NoOfGuests = 4, Status = "Cancelled", BookingNumber = 1056, CreatedDate = new DateTime(2026, 5, 19), Message = null },
                ...
                new Booking { Id = 61, GuestId = 1, SittingId = 1, BookingDate = new DateTime(2026, 6, 10), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1061, CreatedDate = new DateTime(2026, 5, 25), Message = null },
                new Booking { Id = 62, GuestId = 2, SittingId = 2, BookingDate = new DateTime(2026, 6, 10), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1062, CreatedDate = new DateTime(2026, 5, 25), Message = "Glutenfri" },
                new Booking { Id = 63, GuestId = 3, SittingId = 1, BookingDate = new DateTime(2026, 6, 15), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1063, CreatedDate = new DateTime(2026, 5, 28), Message = null },
                new Booking { Id = 64, GuestId = 4, SittingId = 2, BookingDate = new DateTime(2026, 6, 15), NoOfGuests = 4, Status = "Cancelled", BookingNumber = 1064, CreatedDate = new DateTime(2026, 5, 28), Message = null },
                new Booking { Id = 65, GuestId = 5, SittingId = 1, BookingDate = new DateTime(2026, 6, 20), NoOfGuests = 3, Status = "Confirmed", BookingNumber = 1065, CreatedDate = new DateTime(2026, 6, 1), Message = "Vegansk" },
                new Booking { Id = 66, GuestId = 6, SittingId = 2, BookingDate = new DateTime(2026, 6, 20), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1066, CreatedDate = new DateTime(2026, 6, 1), Message = null },

                // Juli 2026
                new Booking { Id = 67, GuestId = 7, SittingId = 1, BookingDate = new DateTime(2026, 7, 4), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1067, CreatedDate = new DateTime(2026, 6, 15), Message = null },
                new Booking { Id = 68, GuestId = 8, SittingId = 2, BookingDate = new DateTime(2026, 7, 4), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1068, CreatedDate = new DateTime(2026, 6, 15), Message = "Skaldjursallergi" },
                ...
                new Booking { Id = 71, GuestId = 11, SittingId = 1, BookingDate = new DateTime(2026, 7, 20), NoOfGuests = 5, Status = "Confirmed", BookingNumber = 1071, CreatedDate = new DateTime(2026, 6, 25), Message = "Glutenintolerant" },
                new Booking { Id = 72, GuestId = 12, SittingId = 2, BookingDate = new DateTime(2026, 7, 20), NoOfGuests = 3, Status = "Cancelled", BookingNumber = 1072, CreatedDate = new DateTime(2026, 6, 25), Message = null },

                // Höst 2026
                new Booking { Id = 73, GuestId = 13, SittingId = 1, BookingDate = new DateTime(2026, 9, 5), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1073, CreatedDate = new DateTime(2026, 8, 20), Message = null },
                new Booking { Id = 74, GuestId = 14, SittingId = 2, BookingDate = new DateTime(2026, 9, 5), NoOfGuests = 2, Status = "Confirmed", BookingNumber = 1074, CreatedDate = new DateTime(2026, 8, 20), Message = "Äggallergi" },
                new Booking { Id = 75, GuestId = 15, SittingId = 1, BookingDate = new DateTime(2026, 10, 10), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1075, CreatedDate = new DateTime(2026, 9, 25), Message = null },
                new Booking { Id = 76, GuestId = 16, SittingId = 2, BookingDate = new DateTime(2026, 10, 10), NoOfGuests = 4, Status = "Pending", BookingNumber = 1076, CreatedDate = new DateTime(2026, 9, 25), Message = null },
                new Booking { Id = 77, GuestId = 17, SittingId = 1, BookingDate = new DateTime(2026, 11, 20), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1077, CreatedDate = new DateTime(2026, 11, 1), Message = "Vegansk" },
                new Booking { Id = 78, GuestId = 18, SittingId = 2, BookingDate = new DateTime(2026, 12, 24), NoOfGuests = 6, Status = "Confirmed", BookingNumber = 1078, CreatedDate = new DateTime(2026, 12, 1), Message = "Julbord, extra speciellt!" },
                new Booking { Id = 79, GuestId = 19, SittingId = 1, BookingDate = new DateTime(2026, 12, 24), NoOfGuests = 4, Status = "Confirmed", BookingNumber = 1079, CreatedDate = new DateTime(2026, 12, 1), Message = null },
                new Booking { Id = 80, GuestId = 20, SittingId = 2, BookingDate = new DateTime(2026, 12, 31), NoOfGuests = 8, Status = "Confirmed", BookingNumber = 1080, CreatedDate = new DateTime(2026, 12, 15), Message = "Nyårsmiddag!" }
            );
            // MailLogs
